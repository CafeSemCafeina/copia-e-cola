...
O Copia e Cola deve vender produtividade, nao quantidade de snippets. O Free Cloud deve ser forte e liberado para uso individual razoavel. O Pro deve ser comprado porque resolve outra dor: produtividade estruturada, modelos reutilizaveis, organizacao avancada e automacoes sem IA.
...
> Salve textos, prompts, comandos e snippets por contexto. Use de graca com sync. Assine o Pro quando precisar transformar repeticao em modelos, bibliotecas e fluxos de trabalho.
...
6. Comparacao Free vs Pro
   - Free: `guardar, encontrar, sincronizar e reutilizar`.
   - Pro: `estruturar, adaptar, versionar e operar bibliotecas`.
   - AI: `transformar contexto em resposta, checklist ou workflow`.
...
8. FAQ
   - `O Free tem limite de snippets?`
     - `Nao como proposta comercial. O Free e liberado para uso individual razoavel; limites tecnicos existem apenas para antiabuso.`
   - `Por que pagar Pro?`
     - `Porque o Pro resolve organizacao avancada, templates, historico, bibliotecas e fluxos de produtividade.`
   - `O Copia e Cola envia meus textos para IA?`
     - `Nao. IA so roda quando voce aciona explicitamente um comando AI.`
...
1. Usuario clica em `Assinar Pro`.
...
7. Extensao/app consulta sessao cloud e libera recursos Pro.
...
- Free Cloud permanece forte; Pro vende ganho objetivo de produtividade estruturada.
